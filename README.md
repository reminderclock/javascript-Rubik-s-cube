...
- `Q`의 경우 조작개수가 카운트 되지 않는다.
- 조작은 `U` `U'` `U2` `L` `L'` `R` `R'` `F` `F'` `Q` 조합만(대문자만) 가능하다.
...
- `U` : 윗면을 시계방향으로 90도 회전
- `U'` : 윗면을 반시계방향으로 90도 회전
- `U2` : 윗면을 시계방향으로 180도 회전
- `L` : 왼면을 시계방향으로 90도 회전
- `L'` : 왼면을 반시계방향으로 90도 회전
- `R` : 오른면을 시계방향으로 90도 회전
- `R'` : 오른면을 반시계방향으로 90도 회전
- `F` : 앞면을 시계방향으로 90도 회전
- `F'` : 앞면을 반시계방향으로 90도 회전
- `Q` : 종료 원할시, 입력
- 조작예시) `UFU2LR'Q`
